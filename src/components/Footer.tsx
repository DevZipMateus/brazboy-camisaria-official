          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  <a 
                    href="https://wa.me/5581994770239" 
                    target="_blank" 
              ...
              <div className="flex items-start">
                ...
                <div>
                  <a 
                    href="mailto:camisariabrazboy89@gmail.com"
                    className="text-primary-foreground/80 hover:text-accent-light transition-colors"
                  >
              ...
              <div className="flex items-start">
                ...
                <div>
                  <a 
                    href="https://instagram.com/brazboy89" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-primary-foreground/80 hover:text-accent-light transition-colors"
                  >
        ...
        <div className="border-t border-primary-light/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-primary-foreground/60 text-sm mb-4 md:mb-0">
              © 2024 Braz Boy Camisaria. Todos os direitos reservados.
            </p>
